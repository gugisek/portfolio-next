...
export default function works({}: Props) {
  ...
  },
  {
    ...
    description: "<p>                Strona z <span style='color: #d800ff'>poradnikami</span> do egzaminów technika informatyka.            </p>                <li>działający pasek wyszukiwania</li>                <li>sortowanie elementów po dacie</li>                <li>pobieranie plików z serwera </li>            <p>                Opiera się na podstronach oraz folderze z elementami jako obiekty na stronie.            </p>",
  ...
  },
  {
    ...
    description: '<p>W pełni zbudowane oraz zaprojektowane przeze mnie <span style="color: #34ad51">w 4 dni</span> dla szkoły na dni otwarte. Prosta budowa na jednej podstronie. Każdy element ma animacje z framer motion. <br/>Pisane sekcja za sekcją. Pomysł na stronę w 100% jest mój.</p>',
  ...
  {
    name: 'PartyHub',
    description: "<p>                Aplikacja do organizacji <span style='color: #ff0000'>imprez</span> w okolicy.            </p>                <li>w pełni operatywny prototyp</li>                <li>warianty dla przycisków</li>                <li>przewidziana funkcja czatów</li>                <li>animacje przejścia</li>            <p>               Zaprojektowane aby łatwo i szybko znajdować nowych ludzi na imprezy. Tylko prototyp.            </p>",
    link: '',
    github: '',
    image1: 'partyhub.png',
  ...
  {
    name: 'AgencyTech.pl',
    description: '<p>                Strona dla agnecji <span style="color: #0097ff">social media</span> świadczącej usługi <span style="color: #0097ff">IT</span>.            </p>                <li>w pełni operatywny prototyp</li>                <li>warianty dla przycisków</li>                <li>zaprojaktowany panel klienta z różnymi sekcjami</li>                <li>widżety w panelu kienta</li>                <li>dynamiczne efekty przewijania na stronie głównej</li>',    link: '',
    github: '',
    image1: 'at4.png',
    image2: 'at2.png',
    image3: 'at3.png',
  ...
  return (
    <section id="projekty" className='min-h-screen text-neutral-900 flex flex-col items-center justify-start pb-7'>
        <motion.h1 
        initial={{opacity: 0, y: 100}}
        whileInView={{opacity: 1, y: 0}}
        transition={{duration: 0.5}}
        className='uppercase font-[Lexend-bold] text-5xl text-[#e0e0e0] py-16'>Moje projekty</motion.h1>
